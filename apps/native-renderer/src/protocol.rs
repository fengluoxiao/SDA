...
fn handle_command(
    ...
    match command {
        ...
        Command::SetSystemLoopback {address,token} => { let accepted=system_loopback::configure(address,token); write_event(&Event::Ack{command:"setSystemLoopback",accepted,detail:None}); },
...
fn command_name(command: &Command) -> &'static str {
    match command {
        ...
        Command::SetSystemLoopback {..} => "setSystemLoopback",
