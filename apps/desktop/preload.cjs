...
contextBridge.exposeInMainWorld("sdaDesktop", {
  ...
  nativeRendererHeadphoneProfile: (id) => ipcRenderer.invoke("sda:native-renderer-headphone-profile", id),
  ...
  nativeRendererFrame: (samplePos, entries) => ipcRenderer.invoke("sda:native-renderer-frame", samplePos, entries),
